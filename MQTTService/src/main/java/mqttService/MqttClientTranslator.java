...
public class MqttClientTranslator {
	...
	public static void main(String[] args) {
		...
		String topic = "/Course/Translator";// the topic you want to display
		String content = "The Reference Letter is available in Portuguese";// message you want to display
		...
		String clientId = "Publisher1"; // define the clientID which must be unique. The client is the borker's client (not the subscriber)
		...
		try {
			...
			opts.setKeepAliveInterval(180);//milliseconds
		...
		//(String topic, String payload, int qos, boolean retained)
			publishMessage("/Course/Translator", "ReferenceLetter - Portuguese", 1,false);//topic/subtopic
